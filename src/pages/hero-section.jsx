...
export default function HeroSection() {
    return (
        <section className="flex flex-col items-center -mt-18">
            ...
            >
                ...
                <defs>
                    <radialGradient id="a" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="rotate(90 428 292)scale(812)">
                        <stop offset=".63" stopColor="#306577" stopOpacity="0" />
                        <stop offset="1" stopColor="#306577" />
                    </radialGradient>
                </defs>
            </motion.svg>
            ...
            >
                <button className="flex items-center gap-2 bg-[#1ab8d0] hover:bg-[#4a98b3] text-[#333333] font-semibold transition-all active:scale-95 rounded-lg px-7 h-11">
                    Get started
